...
import { Download, FileText, Users, Calendar, Filter } from 'lucide-react';
...
export const DemandMatrixExportDialog: React.FC<DemandMatrixExportDialogProps> = ({
  ...
  const getFilterSummary = () => {
    ...
    const isAllClients = selectedClients.length === 0 || selectedClients.length === (demandData.availableStaff?.length || 0);
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground text-center">
              Export includes staff assignments and filtering based on current selection
            </p>
          </div>
