...
/**
 * Staff ID Core Utilities - Normalization and Comparison
 * 
 * This module provides the core staff ID normalization and comparison functions
 * that ensure consistent staff ID formatting across the application to prevent
